...
<head>
    ...
    <title>Hospital Admin - Events</title>
...
<body>
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-100">
        ...
        <div :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}"
            ...
            <nav class="mt-8">
                <a href="dashboard.php" class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                ...
                <a href="#" class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3a2 2 0 712-2h4a2 2 0 712 2v4m-6 9l6-6m0 0v6m0-6H6"></path>
                    </svg>
                    Appointments
                </a>
                ...
                <a href="events.php" class="flex items-center px-6 py-3 text-gray-700 bg-blue-50 border-r-4 border-blue-600">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200">
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <h2 class="ml-4 text-xl font-semibold text-gray-900">Events Management</h2>
                    </div>
            ...
            <!-- Events Content - REAL LIVEWIRE! -->
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
                <?php echo app('livewire')->mount('admin.events.event-list'); ?>
            </main>
        </div>
    </div>
